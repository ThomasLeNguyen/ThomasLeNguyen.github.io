! function(e) {
    ...
    ! function() {
        ...
        function u(e, t) {
            ...
            function f() {
                ...
                return g && g.version && (r.versions.fl = g.version), _ && (r.lcp = _.lcp && void 0 !== _.lcp.value ? _.lcp : r.lcp, r.fid = _.fid && void 0 !== _.fid.value ? _.fid : r.fid, r.cls = _.cls && void 0 !== _.cls.value ? _.cls : r.cls), g && (r.siteToken = g.token), r
            }
            ...
            function d(r) {
                ...
                if (p.documentWriteIntervention = n(), p.firstPaint = t("first-paint"), p.firstContentfulPaint = t("first-contentful-paint"), p.errorCount = window.__cfErrCount || 0, g && (p.siteToken = g.token, L = !0), "function" == typeof l.getEntriesByType) {
                    ...
                    h.forEach(function(e) {
                        ...
                        p.tempResources && void 0 === p.tempResources[S] && (p.tempResources[S] = []);
                        var n = JSON.stringify(t).length;
                        w + n < 62e3 && p.tempResources ? (w += n, p.tempResources[S].push(t)) : (S++, w = 0)
                    })
                }
                ...
                if (l && g && g.token) {
                    ...
                    document.addEventListener("visibilitychange", function() {
                        k && 0 === m.filter(function(e) {
                            return e.id === v
                        }).length && j(), "hidden" === document.visibilityState && !R && L && (R = !0, I(k))
                    });
                    var _ = {
                            lcp: void 0,
                            cls: void 0,
                        ...
                        B = function(e) {
                            ...
                            if ("CLS" === e.name) {
                                ...
                                var n = O(e.entries);
                                n && (_.cls.element = P(n.node), _.cls.currentRect = n.currentRect, _.cls.previousRect = n.previousRect)
                            } else if ("FID" === e.name) {
                                _.fid = {
                                    value: e.value,
                                    path: t
                                ...
                                var n = C(e.entries);
                                n && (_.fid.element = P(n.target), _.fid.name = n.name)
                            } else if ("LCP" === e.name) {
                                _.lcp = {
                                    value: e.value,
                                    path: t
                                ...
                                var n = C(e.entries);
                                n && (_.lcp.element = P(n.element), _.lcp.size = n.size, _.lcp.url = n.url)
                            }
                        };
                    "function" == typeof PerformanceObserver && (a.getLCP(B, !0), a.getFID(B), PerformanceObserver.supportedEntryTypes && PerformanceObserver.supportedEntryTypes.includes("layout-shift") && a.getCLS(B, !0));
                    var k = g && (void 0 === g.spa || !0 === g.spa),
                        ...
                        j = function(e) {
                            var t = function(e, t) {
                                    n.resources = e, 0 != t && (n.bypassTiming = !0), g && (1 === g.r && (n.resources = []), k && 0 === t && (m.push({
                                        id: n.pageloadId,
                                        url: n.location
                                    }), m.length > 3 && m.shift()), o.sendObjectBeacon("", n, function() {}, !1, A), void 0 !== g.forward && void 0 !== g.forward.url && o.sendObjectBeacon("", n, function() {}, !1, g.forward.url))
                                },
                                n = d(e);
                            if (n && g) {
                        ...
                        I = function(e) {
                            var t = f();
                            e || (t.resources = [], delete t.tempResources), g && o.sendObjectBeacon("", t, function() {}, !0, A)
                        },
                        N = function() {
                            L = !0;
                    ...
                    "complete" === window.document.readyState ? N() : window.addEventListener("load", function() {
                        window.setTimeout(N)
                    }), k && (b = e(), function(t) {
                        var n = t.pushState;
                        if (n) {
    ...
    t.__esModule = !0, t.sendObjectBeacon = r
}, function(e, t, n) {
    "use strict";
    t.__esModule = !0;
    var r, i, o, a, c = function(e, t) {
        ...
        T = new Date,
        E = function(e, t) {
            r || (r = t, i = e, o = new Date, L(removeEventListener), b())
        },
        b = function() {
            if (i >= 0 && i < o - T) {
                var e = {
        ...
        _ = function(e, t) {
            ...
            n = d(e, l, t), v && u(function() {
                ...
                var o;
                l = c("FID"), n = d(e, l, t), a = [], i = -1, r = null, L(addEventListener), o = p, a.push(o), b()
            })
        },
        O = new Set,
        C = function(e, t) {
    ...
    t.getFCP = g, t.getCLS = w, t.getFID = _, t.getLCP = C, t.getTTFB = P
}, function(e, t, n) {
    "use strict";
